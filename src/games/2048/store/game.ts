...
import { type Animation } from '@/games/2048/types/Animations';
...
import {
  ...
  updateBoard,
  movePossible,
} from '@/games/2048/utils/board';
import { getStoredData, setStoredData } from '@/games/2048/utils/localStorage';
