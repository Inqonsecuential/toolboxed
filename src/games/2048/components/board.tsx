...
import Tile from '@/games/2048/components/tile';
import useAppDispatch from '@/games/2048/hooks/useAppDispatch';
import useAppSelector from '@/games/2048/hooks/useAppSelector';
import { type Point } from '@/games/2048/types/Models';
import { Direction } from '@/games/2048/types/Direction';
import { moveAction } from '@/games/2048/store/action';
import { type BoardType } from '@/games/2048/utils/board';
import { type Animation, AnimationType } from '@/games/2048/types/Animations';
import Overlay from '@/games/2048/components/overlay';
...
const Board = () => {
  ...
  return (
    <div className='relative'>
      <div
        className={`border-3 grid touch-none select-none gap-4 rounded-md bg-biloba-flower-200 p-5`}
